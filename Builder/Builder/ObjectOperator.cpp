...
//
	void ObjectOperator::Object::Move(float heightModifier)
	{
		...
		if( wektor.posX > oldWektor.posX )
		{
			posX += wektor.posX - oldWektor.posX;
		}
		else if ( wektor.posX < oldWektor.posX )
		{
			posX -= oldWektor.posX - wektor.posX;
		}

		if( wektor.posZ > oldWektor.posZ )
		{
			posZ += wektor.posZ - oldWektor.posZ;
		}
		else if( wektor.posZ < oldWektor.posZ )
		{
			posZ -= oldWektor.posZ - wektor.posZ;
		}
