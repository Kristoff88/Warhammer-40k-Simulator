	...
	switch(message)
	{
		...
		case WM_KEYDOWN:
		{
			switch(toupper(wParam))
			{
				...
				case 'A':	MiniOperator::Singleton().input.KeyDown(KEY_A);		break;
				case 'B':	MiniOperator::Singleton().input.KeyDown(KEY_B);		break;
				case 'C':	MiniOperator::Singleton().input.KeyDown(KEY_C);		break;
				case 'D':	MiniOperator::Singleton().input.KeyDown(KEY_D);		break;
				...
				case 'S':	MiniOperator::Singleton().input.KeyDown(KEY_S);		break;
				case 'T':	MiniOperator::Singleton().input.KeyDown(KEY_T);		break;
				case 'U':	MiniOperator::Singleton().input.KeyDown(KEY_U);		break;
				case 'V':	MiniOperator::Singleton().input.KeyDown(KEY_V);		break;
				case 'W':	MiniOperator::Singleton().input.KeyDown(KEY_W);		break;
		...
		case WM_LBUTTONDOWN:
		{
			miniOperator.input.LeftMouseDown();
		...
		case WM_LBUTTONUP:
		{
			miniOperator.input.LeftMouseUp();
		...
		case WM_RBUTTONDOWN:
		{
			miniOperator.input.RightMouseDown();
		...
		case WM_RBUTTONUP:
		{
			miniOperator.input.RightMouseUp();
			//rButtonDown = false;
			return 0;  
		}
